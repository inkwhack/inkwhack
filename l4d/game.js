...
DeadwalkInput.configure({context:controllerContext,cancel:cancelController,sound:toggleSound,bindings:()=>{promptDevice=null;updateInputPrompts();},device:()=>{if(run)updateHud();else updateInputPrompts();},debugOpen:()=>{if(state==='playing')togglePause();}});
